...
export default function SessionsTable({ sessions, onViewVideo, onViewLog, onDeleteSession }) {
    ...
    <table className="w-full border-collapse">
      <thead>
        <tr className="bg-[#0f0f1c] border-b border-[rgba(91,194,231,0.2)]">
          ...
          <th className="text-left py-3 px-4 text-[#c0c5ce] font-semibold">{t('sessions.video')}</th>
          <th className="text-left py-3 px-4 text-[#c0c5ce] font-semibold">{t('sessions.typescript')}</th>
